...
<head>
    ...
    <link rel="apple-touch-icon" href="{{ asset('/home/images/touch/apple-touch-icon.png') }}">
    <link rel="apple-touch-icon" sizes="72x72" href="{{ asset('/home/images/touch/apple-touch-icon-72x72.png') }}">
    <link rel="apple-touch-icon" sizes="114x114" href="{{ asset('/home/images/touch/apple-touch-icon-114x114.png') }}">
    <link rel="apple-touch-icon" sizes="144x144" href="{{ asset('/home/images/touch/apple-touch-icon-144x144.png') }}">
...
<div class="main">
    <header>
        <div class="wrap">
            <img src="{{ asset('/home/upload/iphone.png') }}" height="532" width="252" alt="" class="header-img">
        ...
        <div class="discover clearfix">
            <div class="wrap" style="">
                <div class="clearfix" style="text-align: center;">
                    ...
                    <img src="{{ asset('/home/images/infrescue.png') }}" style="width: 45%;"/>
                    </p>
                </div>
            </div>
            <!-- /.wrap -->
...
<script src="{{ asset('/home/js/library.js') }}"></script>
<script src="{{ asset('/home/js/script.js') }}"></script>
<script src="{{ asset('/home/js/retina.js') }}"></script>
</body>
</html>